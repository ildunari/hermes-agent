...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="personality_session", description="Set a personality for this Discord thread/session only")
        @discord.app_commands.describe(name="Personality name. Leave empty to list available; use none to clear.")
        async def slash_personality_session(interaction: discord.Interaction, name: str = ""):
            await self._run_simple_slash(interaction, f"/personality_session {name}".strip())
