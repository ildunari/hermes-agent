...
class DaemonThreadPoolExecutor(ThreadPoolExecutor):
    ...
    def _adjust_thread_count(self) -> None:
        ...
        if num_threads < self._max_workers:
            ...
            # Python 3.14 replaced the private _initializer/_initargs worker
            # arguments with a WorkerContext created by the executor. Keep both
            # shapes because Hermes supports runtimes on either side of that
            # stdlib transition.
