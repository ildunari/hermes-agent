...
class ShellFileOperations(FileOperations):
    ...
    def write_file(self, path: str, content: str,
        ...
        # LSP line-shift maps, and user-facing +lines/-lines edit stats. Reuse
        # caller-supplied content when patch_replace already read the file.
        if pre_content is None:
            # Best-effort read; failure (file missing, permission) leaves
            # pre_content as None and downstream consumers degrade gracefully.
