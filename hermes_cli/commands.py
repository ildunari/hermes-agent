...
_SLACK_VIA_HERMES_ONLY = frozenset({
    ...
    "update", "heartbeat", "refine", "review", "pause", "whoami",
    "platform", "insights", "restart_gateways", "restart_hermes", "usage",
})
