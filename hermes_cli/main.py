...
from hermes_cli.subcommands.restart import build_restart_parser
...
def select_provider_and_model(args=None):
    ...
    excluded_provider_slugs = (config.get("model_catalog", {}) or {}).get("excluded_providers") or []
    hidden_provider_slugs = expand_hidden_provider_slugs(
        [*load_hidden_provider_policy(config), *excluded_provider_slugs]
    )
...
def cmd_dashboard(args):
    ...
    # ready sentinel. Resolve it once and preserve it through profile re-exec.
    ...
    if (
        ...
        reexec_argv = [
            ...
            "-p", "default",
            # Preserve the lean serve path across profile re-exec.
    ...
    if _headless_backend:
        # Do not build or mount the dashboard SPA for the headless backend,
        # even when a stale web_dist exists from an earlier dashboard build.
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "stack",
        "restart", "skin", "skills", "slack", "status", "tools", "uninstall", "update",
...
def main():
    ...
    # =========================================================================
    # restart command — detached, drain-aware global surface restart
    # =========================================================================
