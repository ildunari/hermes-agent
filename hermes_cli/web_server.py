...
# Stable semantic marker used by restart/readiness probes. Checking the marker
# prevents an upstream proxy or SPA fallback from turning any HTTP 200 into a
# false-positive dashboard health result.
