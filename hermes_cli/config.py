...
DEFAULT_CONFIG = {
    ...
    "sessions": {
        ...
        # Legacy compatibility: while a pre-v23 database awaits explicit
        # optimize-storage migration, omit its heavyweight inline trigram
        # index and fall back to unicode FTS/LIKE. The compact v23 layout
        # always keeps its tool-row-free trigram index.
