...
Coding plugin de-carry landing (2026-08-31 16:07 ET; landed and deployed): unexpected uncommitted broad rewrites remain preserved in core `decarry-integration-20260831` after its reviewed commit `b17b22b378` (files: `gateway/command_context.py`, `hermes_cli/command_context.py`, `providers/__init__.py`; timestamps 15:58-16:05). They were not part of the completed landing. Do not edit or clean that worktree; coordinate here with its owner.
