...
Coding plugin de-carry landing (2026-08-31 16:07 ET): unexpected uncommitted broad rewrites appeared in core `decarry-integration-20260831` after its reviewed commit `b17b22b378` (files: `gateway/command_context.py`, `hermes_cli/command_context.py`, `providers/__init__.py`; timestamps 15:58-16:05). They are preserved untouched for their owner. Do not edit or clean that worktree. This lane is continuing from reviewed commit `b17b22b378` in fresh `decarry/landing-20260831`; coordinate here before touching either landing branch.
