...
class SessionDB(SessionSearchMixin, SessionSchemaMixin, SessionPortabilityMixin):
    ...
    # Bound long-lived per-thread readers so gateway/dashboard fan-out cannot
    # exhaust the process file-descriptor limit. Overflow readers use the
    # locked writer connection instead.
