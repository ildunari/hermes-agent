...
describe('ModelSettings MoA preset editor', () => {
  ...
  it('saves once the model pick completes the slot', async () => {
    ...
    try {
      ...
      // The UI intentionally humanizes model labels, while the saved payload
      // must retain the exact provider route ID.
      fireEvent.click(await screen.findByRole('option', { name: 'Opus 4.8' }))
      await vi.advanceTimersByTimeAsync(700)
