...
export const zhHant = defineLocale({
  ...
  browserPane: {
    address: '瀏覽器位址',
    addressPlaceholder: '輸入 HTTP(S) 位址',
    back: '上一頁',
    closeTab: '關閉分頁',
    empty: '開啟分頁以開始瀏覽。',
    forward: '下一頁',
    hide: '隱藏瀏覽器窗格',
    invalidAddress: '請輸入有效的 HTTP(S) 位址',
    label: '瀏覽器工作區',
    newTab: '新增分頁',
    ready: '就緒',
    reload: '重新載入',
  ...
  browserSupervision: {
    activity: '最近控制活動',
    activityRetention: '最多保留7天（最多5,000筆事件）。這不是稽核記錄，無法復原網站上的操作。',
    activityTitle: '此 Mac 上的最近活動',
    activityUnavailable: '最近活動未被儲存。',
    controlFailed: '控制變更失敗，請重試。',
    controllerLabel: '受信任的瀏覽器控制',
    generation: '世代',
    handBack: '交還給代理程式',
    operation: '操作',
    operations: { action: '執行', idle: '閒置', navigate: '導覽', snapshot: '快照' },
    owner: '擁有者',
    pause: '暫停代理程式控制',
    profile: '設定檔',
    reasons: { handBack: '交還', pause: '暫停', stop: '停止', takeover: '接管' },
    session: '工作階段',
    states: { agent: '代理程式控制', handingBack: '正在交還', localTakeover: '本機控制', paused: '已暫停' },
    stopAndClose: '停止並關閉',
    tab: '分頁',
    takeControl: '切換為本機控制',
    title: '瀏覽器控制'
  ...
  notifications: {
    ...
    browserIntentBlockedMessage: '此連結需要目前受信任的瀏覽器操作或授權，因此 Hermes 未將其開啟。',
    browserIntentBlockedTitle: '連結未開啟',
    browserIntentOfferMessage: '此連結已在此處提供，在您直接選取前將保持關閉。',
    browserIntentOfferTitle: '連結可供開啟',
    browserResourceFailedMessage: 'Hermes 無法安全地開啟此資源。空白瀏覽器分頁已關閉。',
    browserResourceFailedTitle: '資源未開啟',
  ...
  browserAnnotations: {
    actionResolve: '標記為已解決',
    empty: '此頁面沒有註解。',
    error: '註解無法使用。',
    exportLabel: '匯出含標籤的截圖',
    health: {
      ambiguous: '目標不明確',
      resolved: '已附著',
      shifted: '位置已移動',
  ...
  browserConsent: {
    allowOnce: '僅允許一次',
    browserGeneration: '瀏覽器世代',
    captureScope: '擷取範圍',
    classification: '導覽分類',
    classificationOrdinary: '此工作中視為一般網站',
    classificationSensitive: '敏感',
    classificationUnknown: '未分類 — 視為敏感網站',
    categories: {
      destructiveAction: 'Hermes 即將執行可能變更資料或觸發網站效果的操作。',
      download: '網站想要下載檔案。接下來由你選擇儲存位置。',
      externalHandler: '網站想要透過外部連結處理程式開啟其他應用程式。',
      navigation: 'Hermes 想要將此任務導向其他網站。',
      outboundPixels: 'Hermes 想要與指定接收方分享目前視窗像素。',
      permission: '網站正在要求瀏覽器權限。',
      uploadAssignment: 'Hermes 想要將已暫存的本機檔案指派給此網站。',
      websiteSubmission: 'Hermes 即將提交資訊或觸發對外可見的網站操作。'
    },
    deny: '拒絕',
    detail: '要求詳情',
    expires: '此要求將自動過期。',
    filename: '檔案',
    memoryOnlyRetention: '僅在本次分析期間保留於記憶體中；Hermes 不會保留原始像素。',
    navigationGateWarning: '此導覽決定不會核准上傳、下載、權限、破壞性操作、彈出視窗、外部處理程式或像素擷取。',
    operation: '操作',
    permission: '權限',
    pixelWarning: '像素中可能包含密碼、QR 碼、憑證、個人資料或其他秘密。Hermes 無法在傳送前可靠地遮蔽或清除這些內容。',
    policyReasons: '原則原因',
    policySource: '原則來源',
    purpose: '用途',
    recipient: '接收方',
    retention: '保留方式',
    scheme: '外部連結通訊協定',
    scopeWarning: '核准僅適用於此處顯示的確切任務、分頁、網站、操作和瀏覽器世代。',
    site: '網站',
    tab: '分頁',
    task: '工作',
    taskGeneration: '工作世代',
    profile: '設定檔',
    title: '需要瀏覽器核准',
    treatOrdinary: '此工作中視為一般網站',
    viewportDocumentScope: documentGeneration => `文件世代 ${documentGeneration} 的目前視窗範圍（不是完整頁面）`
  },
  ...
  browserUpload: {
    ...
    sourceStagingWarning:
      '選取此來源僅允許在這台 Mac 上暫時暫存。指派給網站需要個別核准。提交或其他破壞性網站效果之後仍需要另行核准。',
    sourceTitle: '選取 Studio 上傳來源',
    consent: {
      accept: '頁面 accept 宣告',
      aggregate: '總大小',
      destination: '目的地',
      files: '檔案',
      form: '表單',
      immediate: '頁面可能在指派後立即提交',
      input: '輸入欄位',
      mode: '選擇器模式',
      rename: '暫存重新命名',
      sourceLabel: '來源',
      source: 'Mac Studio 工作階段成品／附件',
      warning:
        '獲准頁面來源中的程式碼可以讀取並重新傳輸已指派的檔案。檔案指派不代表核准提交或任何其他破壞性網站效果；這些操作之後仍需要個別核准。'
    }
  },
  ...
  settings: {
    ...
    browser: {
      title: '瀏覽器',
      intro: profile => `目前「${profile}」設定檔的本機瀏覽資料，不會同步至其他桌面端。`,
      restoreTitle: '重新啟動後還原分頁',
      restoreDescription: '僅在本機儲存安全的 HTTP(S) 位址。不會還原表單、頁面內容、私密分頁、憑證或代理控制。',
      historyTitle: '瀏覽記錄',
      historyEmpty: '此設定檔沒有本機瀏覽記錄。',
      clearSite: '清除網站資料',
      clearSiteConfirm: origin => `清除 ${origin} 的 Cookie、儲存空間、Service Worker 與權限？`,
      clearHistory: '清除記錄',
      clearAllData: '清除所有瀏覽資料',
      clearAllDataDescription: '清除此設定檔的網站儲存空間、Cookie、快取、HTTP 驗證、本機記錄、權限與傳輸記錄。',
      clearAllDataConfirm: '清除此設定檔的所有本機瀏覽資料？進行中的瀏覽器自動化將停止。',
      workspaceTitle: '瀏覽器工作區',
      workspaceDescription: '重設已儲存的分頁與活動，但不登出網站。瀏覽記錄可另外選擇。',
      resetWorkspace: '重設已儲存分頁',
      resetWorkspaceAndHistory: '重設分頁與記錄',
      resetConfirm: '重設此瀏覽器工作區？',
      degradedTitle: '瀏覽器中繼資料無法使用',
      degradedDescription: 'Hermes 未還原或導覽任何已儲存分頁。可重試、保留損壞資料庫並重設中繼資料，或清除瀏覽資料。',
      retry: '重試',
      resetMetadata: '重設中繼資料',
      resetMetadataConfirm: '保留損壞資料庫以供修復，並以空白瀏覽器中繼資料重新開始？',
      exportMetadata: '匯出損壞的中繼資料',
      clearBrowsingData: '清除瀏覽資料',
      actionFailed: '無法完成瀏覽器資料操作。',
      partialFailure: scopes => `部分瀏覽器資料已變更，但以下範圍操作失敗：${scopes}。`,
      siteDataScope: '網站儲存空間',
      metadataScope: '本機中繼資料',
      permissionsScope: '權限',
      activityScope: '活動',
      workspaceScope: '工作區狀態',
      originMetadataOnly: '此來源存在於權限或傳輸記錄中。',
      permissionsTitle: '網站權限',
      permissionsDescription: '持久決定僅適用於人工瀏覽時完全相符的來源。代理任務仍需單次同意。',
      permissionOrigin: '完全相符的網站來源',
      permissionName: '權限名稱',
      permissionsEmpty: '沒有持久網站權限決定。',
      allow: '允許',
      deny: '拒絕',
      allowed: '已允許',
      denied: '已拒絕',
  ...
  profiles: {
    ...
    deleteDescMid: ' 並移除其 ',
    deleteDescSuffix:
      ' 目錄、本機瀏覽器工作區、網站登入與網站資料、近期活動和註解套件。Desktop 解除安裝是另一項操作。此操作無法復原。',
    deleting: '刪除中…',
