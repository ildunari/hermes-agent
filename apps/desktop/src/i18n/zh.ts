...
export const zh: Translations = {
  ...
  browserPane: {
    address: '浏览器地址',
    addressPlaceholder: '输入 HTTP(S) 地址',
    back: '后退',
    closeTab: '关闭标签页',
    empty: '打开标签页以开始浏览。',
    forward: '前进',
    hide: '隐藏浏览器窗格',
    invalidAddress: '请输入有效的 HTTP(S) 地址',
    label: '浏览器工作区',
    newTab: '新标签页',
    ready: '就绪',
    reload: '重新加载',
  ...
  browserSupervision: {
    activity: '最近控制活动',
    activityRetention: '最多保留7天（最多5,000条事件）。这不是审计日志，无法撤销网站上的操作。',
    activityTitle: '此 Mac 上的最近活动',
    activityUnavailable: '最近活动未被保存。',
    controlFailed: '控制变更失败，请重试。',
    controllerLabel: '可信浏览器控制',
    generation: '代',
    handBack: '交还给智能体',
    operation: '操作',
    operations: { action: '执行', idle: '空闲', navigate: '导航', snapshot: '快照' },
    owner: '所有者',
    pause: '暂停智能体控制',
    profile: '配置',
    reasons: { handBack: '交还', pause: '暂停', stop: '停止', takeover: '接管' },
    session: '会话',
    states: { agent: '智能体控制', handingBack: '正在交还', localTakeover: '本地控制', paused: '已暂停' },
    stopAndClose: '停止并关闭',
    tab: '标签页',
    takeControl: '接管到本地',
    title: '浏览器控制'
  ...
  notifications: {
    ...
    browserIntentBlockedMessage: '此链接需要当前可信的浏览器操作或授权，因此 Hermes 未将其打开。',
    browserIntentBlockedTitle: '链接未打开',
    browserIntentOfferMessage: '此链接已在此处提供，在你直接选择前将保持关闭。',
    browserIntentOfferTitle: '链接可供打开',
    browserResourceFailedMessage: 'Hermes 无法安全地打开此资源。空白浏览器标签页已关闭。',
    browserResourceFailedTitle: '资源未打开',
  ...
  browserAnnotations: {
    actionResolve: '标记为已解决',
    empty: '此页面没有注释。',
    error: '注释不可用。',
    exportLabel: '导出带标签的截图',
    health: {
      ambiguous: '目标不明确',
      resolved: '已附着',
      shifted: '位置已移动',
  ...
  browserConsent: {
    allowOnce: '仅允许一次',
    browserGeneration: '浏览器代次',
    captureScope: '捕获范围',
    classification: '导航分类',
    classificationOrdinary: '此任务中按普通网站处理',
    classificationSensitive: '敏感',
    classificationUnknown: '未分类 — 按敏感网站处理',
    categories: {
      destructiveAction: 'Hermes 即将执行可能更改数据或触发网站效果的操作。',
      download: '网站想要下载文件。接下来由你选择保存位置。',
      externalHandler: '网站想要通过外部链接处理程序打开其他应用。',
      navigation: 'Hermes 想要将此任务导航到其他网站。',
      outboundPixels: 'Hermes 想要与指定接收方共享当前视口像素。',
      permission: '网站正在请求浏览器权限。',
      uploadAssignment: 'Hermes 想要将已暂存的本地文件分配给此网站。',
      websiteSubmission: 'Hermes 即将提交信息或触发对外可见的网站操作。'
    },
    deny: '拒绝',
    detail: '请求详情',
    expires: '此请求将自动过期。',
    filename: '文件',
    memoryOnlyRetention: '仅在本次分析期间保留于内存中；Hermes 不会保留原始像素。',
    navigationGateWarning: '此导航决定不批准上传、下载、权限、破坏性操作、弹窗、外部处理程序或像素捕获。',
    operation: '操作',
    permission: '权限',
    pixelWarning: '像素中可能包含密码、二维码、凭据、个人数据或其他秘密。Hermes 无法在发送前可靠地遮盖或清除这些内容。',
    policyReasons: '策略原因',
    policySource: '策略来源',
    purpose: '用途',
    recipient: '接收方',
    retention: '保留方式',
    scheme: '外部链接协议',
    scopeWarning: '批准仅适用于此处显示的确切任务、标签页、网站、操作和浏览器代次。',
    site: '网站',
    tab: '标签页',
    task: '任务',
    taskGeneration: '任务代次',
    profile: '配置',
    title: '需要浏览器批准',
    treatOrdinary: '此任务中按普通网站处理',
    viewportDocumentScope: documentGeneration => `文档代次 ${documentGeneration} 的当前视口（不是完整页面）`
  },
  ...
  browserUpload: {
    ...
    sourceStagingWarning:
      '选择此来源仅允许在这台 Mac 上临时暂存。分配给网站需要单独批准。提交或其他破坏性网站效果需要之后再次单独批准。',
    sourceTitle: '选择 Studio 上传来源',
    consent: {
      accept: '页面 accept 声明',
      aggregate: '总大小',
      destination: '目标',
      files: '文件',
      form: '表单',
      immediate: '页面可能在分配后立即提交',
      input: '输入框',
      mode: '选择器模式',
      rename: '暂存重命名',
      sourceLabel: '来源',
      source: 'Mac Studio 会话工件/附件',
      warning:
        '获准页面源中的代码可以读取并重新传输已分配的文件。文件分配不代表批准提交或任何其他破坏性网站效果；这些操作之后需要单独批准。'
    }
  },
  ...
  settings: {
    ...
    browser: {
      title: '浏览器',
      intro: profile => `当前“${profile}”配置文件的本机浏览数据，不会同步到其他桌面端。`,
      restoreTitle: '重启后恢复标签页',
      restoreDescription: '仅在本机保存安全的 HTTP(S) 地址。不会恢复表单、页面内容、隐私标签页、凭据或智能体控制。',
      historyTitle: '浏览历史',
      historyEmpty: '此配置文件没有本机浏览历史。',
      clearSite: '清除站点数据',
      clearSiteConfirm: origin => `清除 ${origin} 的 Cookie、存储、Service Worker 和权限？`,
      clearHistory: '清除历史',
      clearAllData: '清除所有浏览数据',
      clearAllDataDescription: '清除此配置文件的站点存储、Cookie、缓存、HTTP 身份验证、本机历史、权限和传输记录。',
      clearAllDataConfirm: '清除此配置文件的所有本机浏览数据？正在进行的浏览器自动化将停止。',
      workspaceTitle: '浏览器工作区',
      workspaceDescription: '重置已保存的标签页和活动，但不退出网站。历史记录可单独选择。',
      resetWorkspace: '重置已保存标签页',
      resetWorkspaceAndHistory: '重置标签页和历史',
      resetConfirm: '重置此浏览器工作区？',
      degradedTitle: '浏览器元数据不可用',
      degradedDescription: 'Hermes 未恢复或导航任何已保存标签页。可重试、保留损坏数据库并重置元数据，或清除浏览数据。',
      retry: '重试',
      resetMetadata: '重置元数据',
      resetMetadataConfirm: '保留损坏数据库以供修复，并使用空的浏览器元数据重新开始？',
      exportMetadata: '导出损坏的元数据',
      clearBrowsingData: '清除浏览数据',
      actionFailed: '无法完成浏览器数据操作。',
      partialFailure: scopes => `部分浏览器数据已更改，但以下范围操作失败：${scopes}。`,
      siteDataScope: '站点存储',
      metadataScope: '本地元数据',
      permissionsScope: '权限',
      activityScope: '活动',
      workspaceScope: '工作区状态',
      originMetadataOnly: '此来源存在于权限或传输记录中。',
      permissionsTitle: '站点权限',
      permissionsDescription: '持久决定仅适用于人工浏览时完全匹配的来源。智能体任务仍需一次性同意。',
      permissionOrigin: '完全匹配的站点来源',
      permissionName: '权限名称',
      permissionsEmpty: '没有持久站点权限决定。',
      allow: '允许',
      deny: '拒绝',
      allowed: '已允许',
      denied: '已拒绝',
  ...
  profiles: {
    ...
    deleteDescMid: ' 并移除其 ',
    deleteDescSuffix:
      ' 目录、本地浏览器工作区、网站登录与站点数据、最近活动和注释包。Desktop 卸载是另一项操作。此操作无法撤销。',
    deleting: '删除中…',
