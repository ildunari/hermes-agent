...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # ensures explicit 5.2/5.3 entries resolve to 1M while older variants hit the
    ...
    "grok-build-latest": 500000,  # Grok Build rolling alias
...
_PRE_CATALOG_STALE_KEYS = frozenset({
    ...
    "glm-5.3",       # 1M; pre-catalog builds persisted the "glm-5" catch-all (131,072)
