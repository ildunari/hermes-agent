...
class TurnContext:
    ...
    compact_tool_counts: Any = None
    compact_todo_args: list = field(default_factory=lambda: [None])
    ...
    extension_identity_scope: Any = None
    ...
    voice_reply_consumer_holder: list = field(default_factory=lambda: [None])
    voice_reply_generation_holder: list = field(default_factory=lambda: [0])
    live_voice_guild: Any = None
