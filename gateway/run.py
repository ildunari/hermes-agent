    ...
    if isinstance(cron_provider, InProcessCronScheduler) and multiplex_cron:
        try:
            ...
            if profile_homes:
                ...
                # runner.adapters belongs to the launch profile; naming it keeps the ticker from routing a
                # secondary's cron through that bot and lets a named multiplexer's own jobs reuse its adapters.
